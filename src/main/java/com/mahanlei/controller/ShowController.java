...
@RequestMapping(value = "/show")
    ...
    public  JSONObject getShowInfo(@RequestParam ("showId") int showId){
        ...
        jsonObject.put("startTime",showInfo.getStartTime());
        jsonObject.put("endTime",showInfo.getEndTime());
        jsonObject.put("type",TransDataType.showTypeToInt(showInfo.getType()));
